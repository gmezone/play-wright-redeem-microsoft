...
var j,A=/\S+/g,L={}
function q(){f.removeEventListener("DOMContentLoaded",q,!1),e.removeEventListener("load",q,!1),d.ready()}d.Callbacks=function(e){var t,n,r,i,o,s,a=[],u=!(e="string"==typeof e?L[e]||function(e){var t=L[e]={}
return d.each(e.match(A)||[],function(e,n){t[n]=!0}),t}(e):d.extend({},e)).once&&[],l=function(f){for(t=e.memory&&f,n=!0,s=i||0,i=0,o=a.length,r=!0;a&&o>s;s++)if(!1===a[s].apply(f[0],f[1])&&e.stopOnFalse){t=!1
